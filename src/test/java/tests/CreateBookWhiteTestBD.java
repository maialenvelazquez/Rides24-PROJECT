...
public class CreateBookWhiteTestBD {
	...
	@Test
	//sut.createBook: The Traveler() HAS one book "from" "to" in that "date"
	public void test1() {
	...
	@Test
	//sut.createBook: The Traveler() HAS NOT one book "from" "to" in that "date"
	public void test2() {
	...
	@Test
	//sut.creteBook: The ride is null. The test must return null. If an exception is returned createBook method is not well implemented
	public void test4() {
		...
		Integer rideNumber=null;
		try {
			//Driver d= new Driver(NAND, log, password, email, izena, abizena, jaiotzeData, telefonoZenbakia, sexua);
			//Kotxe k= new Kotxe(matrikula,marka,modeloa,eserlekuKopurua, d);
			//Integer rideNumber, String from, String to, Date date, int nPlaces, float price, Driver driver, Kotxe k
			testDA.open();
			testDA.createTraveler(NANT, log, password, email, izena, abizena, jaiotzeData, telefonoZenbakia, sexua);
			testDA.close();
	...
	@Test
	//sut.createBook: The ride doesn't have enough seats
	public void test6() {
		String NAND = "12345678Z";
		String log = "maite_izarra";
		String password = "Txakur@2025!";
